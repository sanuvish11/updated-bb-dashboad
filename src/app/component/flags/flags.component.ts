...
export class FlagsComponent implements OnInit {
  ...
  getAllChatRooms() {
    this.authService.allChatRooms().subscribe(data => {
      ...
      // const descendingChat =  this.allChatRooms.sort((a:any,b:any) => 0 - (a > b ? 1 : -1));
      // console.log(descendingChat)
      // this.allChatRooms= descendingChat
    })
  }
...
function toLocaleDateString(arg0: string) {
